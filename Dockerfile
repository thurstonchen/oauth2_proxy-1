...
RUN wget https://github.com/thurstonchen/oauth2_proxy/releases/download/2.2.1-alpah/oauth2_proxy-2.2.1-alpha.linux-amd64.go1.11.4.tar.gz -O /tmp/oauth2_proxy.tar.gz \
